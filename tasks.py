...
#Listalle voi lisätä uuden tehtävän, jolla on tietty nimi ja prioriteetti, sekä listalta voi hakea käsittelyyn suurimman prioriteetin tehtävän.
#Voit olettaa, että työtehtävän nimi muodostuu merkeistä a–z ja 0–9 ja prioriteetti on kokonaisluku välillä 0…109.
